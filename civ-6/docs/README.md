...
- `leaders/`: 지도자 10명. 통치의 배경과 게임 능력이 끌어온 역사적 모티프
- `civilizations/`: 문명 8개. 장기 변화와 교류를 중심으로 한 개관
- `cities/`: 도시 10곳. 도시의 시대별 역할과 게임에서의 위치
- `great-people/`: 위인 9명. 과학자·작가·예술가·공학자·음악가로 구분
