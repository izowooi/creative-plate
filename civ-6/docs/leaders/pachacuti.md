...
sources:
  ...
  - title: "Qhapaq Ñan, Andean Road System — UNESCO World Heritage Centre"
...
Civ6의 지도자 능력 ‘카팍 냔’은 국내 교역로가 출발 도시 영토의 산 타일마다 식량을 더 얻게 하고, 외국 무역 사회 제도에서 건설자가 산을 관통하는 카팍 냔 시설을 놓게 한다. 산맥을 장애물이 아니라 식량 분배와 이동망의 핵심으로 바꾸는 설계다. 다만 잉카 경제를 현대적 시장 교역로로 그대로 볼 수는 없다. 실제 도로망은 화폐 시장보다 국가의 재분배, 미타 노동, 군사·행정 통신에 깊이 연결되었고 여러 세대에 걸쳐 확대되었다.

## 핵심 연표/사실

- 1438년경: 전통 연대상 찬카 공격을 물리치고 잉카 통치자가 됨
- 15세기 중엽: 쿠스코 재건과 타완틴수유의 네 구역 행정 정비
- 15세기 중엽: 도로·역참·저장망 확대와 주변 지역 통합
- 1450년경 이후: 마추픽추 조성 시기로 흔히 추정
- 1471년경: 투팍 잉카 유팡키에게 권력이 이어진 것으로 전함
