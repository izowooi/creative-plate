---
id: "great-work:GREATWORK_REMBRANDT_1"
name: 안드리스 더흐라프의 초상
nameEn: Andries de Graeff
category: great-works
subcategory: portrait
accent: amber
era: 네덜란드 황금시대
region: 네덜란드·독일
tags: [초상화, 렘브란트, 암스테르담 섭정층, 인물 식별, 위대한 미술품]
summary: "1639년 렘브란트가 그린 실물 크기 전신 초상은 안드리스 더흐라프로 추정되지만 식별이 확정되지 않았다. 게임의 짧은 이름 뒤에 남아 있는 초상 주인공의 불확실성을 함께 살핀다."
greatWork:
  gameId: "GREATWORK_REMBRANDT_1"
  creatorId: "rembrandt"
  historicalTitle: "Portrait of a Man Standing, possibly Andries de Graeff"
  creation:
    label: "1639년"
    yearStart: 1639
    yearEnd: 1639
    ...
    medium: "캔버스에 유채"
    note: "화면에 Rembrandt v. 1639라는 서명이 있으며 인물의 신원은 추정이다."
  attribution: "렘브란트의 서명작으로 인정되지만, 서 있는 남성이 안드리스 더흐라프인지에 대해서는 소장관도 유보적이다."
  holding:
    status: single
  ...
  workRights:
    ...
    source: "https://commons.wikimedia.org/wiki/File:Portrait_of_Andries_de_Graeff_%E2%80%93_Rembrandt.jpg"
    jurisdiction: "17세기 회화"
    note: "회화 자체는 public domain이며 디지털 재현 파일의 조건은 Commons 기록을 따른다."
  imageRole: work
  audio:
    status: unavailable
...
이 차이는 초상화가 단순한 얼굴 복사가 아니라는 사실을 드러낸다. 복식과 자세, 화면 크기, 주문 맥락은 인물이 어떻게 보이기를 원했는지 말해 주지만, 기록이 끊기면 그 사회적 연출만 남고 이름은 흔들릴 수 있다. 작품은 1752년 함부르크의 게르하르트 모렐을 통해 헤센카셀의 빌헬름 8세 컬렉션으로 들어왔고, 오늘날 카셀의 옛 거장 회화관에 있다. 한때 붙은 이름을 영구한 사실로 반복하기보다, 표제 자체가 연구에 따라 달라지는 박물관 지식의 일부임을 함께 보여 주는 작품이다.

## 게임에서 다시 보기

《문명 VI》에서 렘브란트는 산업 시대 위대한 미술가이며, 《Andries de Graeff》는 그가 만드는 초상화 두 점 가운데 하나다. 작품은 문화 +3·관광 +2를 생산한다. 미술관 테마 보너스를 받으려면 같은 유형인 초상화 세 점을 서로 다른 미술가에게서 모아야 하므로, 실제로 같은 작가의 작품을 함께 연구하는 방식과 다른 교환 퍼즐이 생긴다. 게임은 불확실한 시터 식별을 짧은 고유명으로 고정하고, 카셀에 묶인 대형 캔버스를 이동 가능한 수장품으로 바꾼다. 역사적으로 읽을 때는 ‘렘브란트 작품’이라는 귀속과 ‘더흐라프를 그렸다’는 식별의 확실성이 서로 다름을 구분해야 한다.

## 핵심 연표/사실

- 1611년: 안드리스 더흐라프가 암스테르담의 유력 가문에서 태어남
- 1639년: 렘브란트가 서명과 연도를 남긴 전신 초상을 완성
- 1657~1671년: 더흐라프가 여러 차례 암스테르담 시장직을 맡음
- 1672년: 재난의 해 이후 더흐라프 가문의 정치적 영향력이 약화
- 1678년: 안드리스 더흐라프 사망
- 1752년: 빌헬름 8세를 위해 작품이 구입되어 카셀 컬렉션에 편입
- 21세기: 카셀 소장관은 시터를 안드리스 더흐라프로 ‘추정’해 표기
- 2016년: 《문명 VI》에서 렘브란트의 위대한 초상화로 수록
